...
class RP_Care_Environment {
	...
	public static function get_status_report(): array {
		...
		return [
			...
			'plan'                   => (string) ( $opts['plan'] ?? get_option( 'rpcare_detected_plan', '' ) ),
			'addons'                 => array_values( array_map( 'sanitize_key', (array) ( $opts['addons'] ?? [] ) ) ),
			'feature_grants'         => class_exists( 'RP_Care_Plan' ) ? RP_Care_Plan::get_feature_grants() : [],
