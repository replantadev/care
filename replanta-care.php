...
class ReplantaCare {
    ...
    public function load_dependencies() {
        ...
        $required_files = [
            ...
            'inc/class-seo-index-inventory.php',
            'inc/class-rest.php',
            'inc/class-utils.php',
    ...
    public function maybe_auto_onboard(): void {
        ...
        if (200 === $http_code) {
            ...
            if (class_exists('RP_Care_Plan')) {
                ...
                $feature_grants = array_key_exists('feature_grants', $body) && is_array($body['feature_grants'])
                    ? $body['feature_grants']
                    : null;
                RP_Care_Plan::apply_hub_entitlements($status, $plan, $addons, $feature_grants);
            }
